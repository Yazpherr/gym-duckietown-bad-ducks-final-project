...
def line_follower(vel, angle, obs):
    ...
    if duckie_detected:
        ...
        all_detections = duckie_frame  # Usar la detección de pato como base
    ...
    if line_white != (0, 0, 0, 0):
        pos_x, pos_y = env.cur_pos[0], env.cur_pos[2]
        x_vel, rot_vel = PID_controller(pos_x, pos_y, line_white[2], line_white[3])
    else:
        x_vel = 0
