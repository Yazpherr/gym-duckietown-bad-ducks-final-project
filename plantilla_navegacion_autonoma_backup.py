...
def get_line(converted, filter_1, filter_2, line_color):
    ...
    '''
    # cortar la imagen para tener zona relevante
    height, width = converted.shape[:2]
    img = np.zeros_like(converted)
    img[260:640, 0:640] = converted[260:640, 0:640]

    # Crea una mascara de filtro 
    ...
    # Si nosotros encontramos la linea
    if lines is not None:
        for rho, theta in lines [0]:
            ...
            x2 = int(x0 - 1000*(-b))
            y2 = int(y0 - 1000*(a))
            # coordenadas del inicio y coodenadas final de las lineas
            line_point = (x1, y1, x2, y2)
            # obtenemos el angulo de la linea como lista
    ...
    # VERIFICAR DE DONDE SALE EL LINE COLORS 
    ...
    # y viceversa.
    return angle, line_point, image_lines
    # return 0, 0
...
#def line_follower(vel, angle, obs):
    ...
    road_detections = cv2.addWeighted(road_frame, 1, real_line_frame, 1, 0)
    ...
    # Implementar un controlador para poder navegar dentro del mapa con los ángulos obtenidos en las líneas anteriores
...
def get_angle_radians(line_points):
    # Implementar lógica para calcular ángulo en radianes
    pass

def get_angle_degrees(line_points):
    # Implementar lógica para calcular ángulo en grados
    pass

def duckie_detection(obs, frame, converted):
    # Implementar detección de duckies
    # Debe retornar duckie_detection_, duckie_angle, duckie_frame
    pass

def red_line_detection(converted, frame):
    # Implementar detección de líneas rojas
    # Debe retornar stop_detection, red_line_frame
    pass

def get_line(converted, filter_1, filter_2, line_color):
    # Implementar detección de líneas
    # Debe retornar angle, line_points, image_lines
    pass

def line_intersect(line1, line2):
    # Implementar lógica para encontrar la intersección de dos líneas
    pass

def PID_controller(pos_x, pos_y, x_objetivo, y_objetivo):
    # Implementar controlador PID
    # Debe retornar x_vel, rot_vel
    pass
